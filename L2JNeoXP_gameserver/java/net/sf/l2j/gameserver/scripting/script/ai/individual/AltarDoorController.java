...
public class AltarDoorController extends DefaultNpc
{
	...
	public void onScriptEvent(Npc npc, int eventId, int arg1, int arg2)
	{
		...
		else if (eventId == 2)
		{
			...
			startQuestTimer("2002", npc, null, (3 * 60) * 1000);
		}
		else if (eventId == 3)
		{
			npc._i_ai1 = 1;
			startQuestTimer("2003", npc, null, (2 * 60) * 1000);
		}
		else if (eventId == 5)
		{
			if (doorName3rdFloor != null)
			...
			startQuestTimer("2004", npc, null, (3 * 60) * 1000);
		}
		else if (eventId == 6)
		{
			if (doorName3rdFloor != null)
			...
			startQuestTimer("2005", npc, null, (3 * 60) * 1000);
		}
		else if (eventId == 7)
		{
			if (doorName3rdFloor != null)
			...
			startQuestTimer("2006", npc, null, (60 * 60) * 1000);
		}
		if (eventId < 9)
		{
			npc._i_ai0 = eventId;
