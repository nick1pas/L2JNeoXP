...
public class CastleWarehouseKeeper extends WarehouseKeeper
{
	...
	public void showChatWindow(Player player, int val)
	{
		...
		if (condition == NpcTalkCond.NONE)
			html.setFile(player.getLocale(), "html/castlewarehouse/castlewarehouse-no.htm");
		else if (condition == NpcTalkCond.UNDER_SIEGE)
			html.setFile(player.getLocale(), "html/castlewarehouse/castlewarehouse-busy.htm");
		else
		{
			if (val == 0)
				html.setFile(player.getLocale(), "html/castlewarehouse/castlewarehouse.htm");
			else
				html.setFile(player.getLocale(), "html/castlewarehouse/castlewarehouse-" + val + ".htm");
		}
