...
public class ClanHallDecoration extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		if (chf == null || chf.getLvl() == 0)
			writeC(0);
		else if ((_ch.getSize() == 0 && chf.getLvl() < 220) || (_ch.getSize() == 1 && chf.getLvl() < 160) || (_ch.getSize() == 2 && chf.getLvl() < 260) || (_ch.getSize() == 3 && chf.getLvl() < 300))
			writeC(1);
		else
			writeC(2);
		...
		else if (((_ch.getSize() == 0 || _ch.getSize() == 1) && chf.getLvl() < 25) || (_ch.getSize() == 2 && chf.getLvl() < 30) || (_ch.getSize() == 3 && chf.getLvl() < 40))
		{
			writeC(1);
			writeC(1);
		}
		...
		if (chf == null || chf.getLvl() == 0)
			writeC(0);
		else if ((_ch.getSize() == 0 && chf.getLvl() < 25) || (_ch.getSize() == 1 && chf.getLvl() < 30) || (_ch.getSize() == 2 && chf.getLvl() < 40) || (_ch.getSize() == 3 && chf.getLvl() < 50))
			writeC(1);
		else
			writeC(2);
		...
		if (chf == null || chf.getLvl() == 0)
			writeC(0);
		else if ((_ch.getSize() == 0 && chf.getLvl() < 2) || chf.getLvl() < 3)
			writeC(1);
		else
			writeC(2);
		...
		else if ((_ch.getSize() == 0 && chf.getLvl() < 2) || (_ch.getSize() == 1 && chf.getLvl() < 4) || (_ch.getSize() == 2 && chf.getLvl() < 5) || (_ch.getSize() == 3 && chf.getLvl() < 8))
		{
			writeC(1);
			writeC(1);
		}
